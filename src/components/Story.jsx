...
const Story = () => {
  return (
    <div className="overflow-hidden h-[85vh] sm:h-screen shadow-[-1px_-12px_400px_151px_rgba(0,0,0,1)]">
      <div
        data-scroll
              ...
              <div className="flex gap-28 sm:gap-32">
                <ul className="space-y-2 max-sm:hidden">
                  {[
                    ...
                    <a
                      key={item}
                      className=" hover:text-white block text-sm opacity-85"
                      href="#"
                    >
                      {item}
                    </a>
                ...
                <ul className="space-y-2">
                  {["Work", "Studio", "News", "contact"].map((item) => (
                    <a
                      key={item}
                      className=" hover:text-white block text-sm opacity-85 capitalize"
                      href="#"
                    >
                      {item}
                    </a>
